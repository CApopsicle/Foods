...
class FoodsControllerTest < ActionController::TestCase
  ...
  test "should create food" do
    assert_difference('Food.count') do
      post :create, food: { color: @food.color, count: @food.count, fresh: @food.fresh, name: @food.name }
    end
  ...
  test "should update food" do
    patch :update, id: @food, food: { color: @food.color, count: @food.count, fresh: @food.fresh, name: @food.name }
    assert_redirected_to food_path(assigns(:food))
  end
